...
<div class="dashboard-header">
        <nav class="navbar navbar-expand-lg bg-white fixed-top">
            ...
            <a class="navbar-brand" href="<?php echo e(route('dashboard')); ?>"><?php echo e(settingHelper('application_name')); ?></a>
    ...
    <!-- end navbar -->
    <!-- ============================================================== -->
<?php /**PATH C:\laragon\www\temancms\Modules\Common\Providers/../Resources/views/layouts/header.blade.php ENDPATH**/ ?>