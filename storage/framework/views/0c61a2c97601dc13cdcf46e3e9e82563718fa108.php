                    ...
                    <div class="d-flex ">
                        <div class="sg-social d-none d-xl-block mr-md-5">
                            <ul class="global-list">
                                ...
                                <li><a href="<?php echo e($socialMedia->url); ?>" target="_blank" name="<?php echo e($socialMedia->name); ?>"><i class="<?php echo e($socialMedia->icon); ?>" aria-hidden="true"></i></a></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <li><a href="<?php echo e(url('feed')); ?>" name="<?php echo e(__('feed')); ?>"><i class="fa fa-rss" aria-hidden="true"></i></a></li>
                            </ul>
                        </div>
                        <div class="sg-user">
                    ...
                    <div class="sg-search">
                        <div class="search-form">
                            <form action="<?php echo e(route('article.search')); ?>" id="search" method="GET">
                                <label for="label" class="d-none"><?php echo e(__('search')); ?></label>
                                <input class="form-control" id="label" name="search" type="text" placeholder="<?php echo e(__('search')); ?>">
                                <button type="submit"><i class="fa fa-search"></i><span class="d-none"><?php echo e(__('search')); ?></span></button>
                            </form>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\laragon\www\temancmss\resources\views/site/layouts/header/style_1.blade.php ENDPATH**/ ?>