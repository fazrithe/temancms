...
<main id="reportase">
    <div class="container">
        ...
        <div class="row">
            ...
            <span > <a  class="author me-1" href="<?php echo e(route('site.author',['id' => $post->user->id])); ?>"><?php echo e($post->user->first_name); ?>  </a> <?php echo e($post->updated_at->format('F j, Y')); ?></span>
            </div>
