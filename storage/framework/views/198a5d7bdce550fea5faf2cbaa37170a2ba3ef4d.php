...
$php_version_required_min = "7.2";
$php_version_required_max = "7.4.23";
$current_php_version = PHP_VERSION;

//check required php version
if (version_compare($current_php_version, $php_version_required_min) >= 0 && version_compare($current_php_version, $php_version_required_max) <= 0) {
...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="<?php echo e(static_asset('images/favicon.png')); ?>" />
        <title>CMSKU</title>
                ...
                <div class="panel-body no-padding">
                    ...
                    <div class="tab-content">
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><?php echo $php_version_required_min; ?> - <?php echo $php_version_required_max; ?></td>
                        ...
                        <div role="tabpanel" class="tab-pane" id="finished-tab">
                            <div class="section">
                                <div class="clearfix">
                                    <i class="status fa fa-check-circle-o pull-left"> </i><span class="pull-left">Congratulation! You have successfully installed <strong>  Teman CMS</strong></span>
                                </div>
...
<?php /**PATH C:\laragon\www\temancmss\Modules\Installer\Providers/../Resources/views/index.blade.php ENDPATH**/ ?>