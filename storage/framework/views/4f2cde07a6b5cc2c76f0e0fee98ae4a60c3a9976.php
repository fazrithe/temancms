...
<?php endif; ?>
            ...
            <section id="list-reportase">
                <div class="container mt-3">
                    ...
                    <div class="theiaStickySidebar">
                        <?php echo $__env->make('site2.partials.home.category_section_reportase', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </section>
            <section id="list-serial">
                <div class="container mt-4">
                    ...
                    <div class="theiaStickySidebar">
                        <?php echo $__env->make('site2.partials.home.category_section_serial', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </section>
