<?php $__env->startSection('content'); ?>
        ...
        <div class="container">
            ...
            <div class="col-lg-6 register-account ">
                <h1 class="fs-4 mb-4"><?php echo e(__('sign_up')); ?></h1>
                ...
                <form class="ragister-form" name="ragister-form" method="post" action="<?php echo e(route('site.register')); ?>">
                    ...
                    <?php endif; ?>
                    <button class="button-primary mb-4" type="submit"><?php echo e(__('sign_up')); ?></button>
                    <div class="middle-content">
                        <p><?php echo e(__('already_have_an_account')); ?> <a class="sign-up" href="<?php echo e(route('site.login.form')); ?>"><?php echo e(__('login')); ?></a></p> 
                    </div>
                </form>
...
<?php echo $__env->make('site2.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\temancms\resources\views/site2/auth/register.blade.php ENDPATH**/ ?>