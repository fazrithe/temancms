...
<?php $__env->startSection('post'); ?>
    active
<?php $__env->stopSection(); ?>
<?php $__env->startSection('submitted-post-active'); ?>
    active
<?php $__env->stopSection(); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="block-header">
                                                <h2><?php echo e(__('submitted_posts')); ?></h2>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="post-image">
                                                        <?php if(isFileExist(@$post->image, $result = @$post->image->thumbnail)): ?>
                                                            <img
                                                                ...
                                                                alt="image"
                                                                class="img-responsive img-thumbnail lazyloaded">
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php elseif($post->status == 1): ?>
                                                            <a href="javascript:void(0)"
                                                               ...
                                                               name="option" class="btn btn-light active btn-xs">
                                                                <i class="fa fa-times option-icon"></i> <?php echo e(__('unpublish')); ?>
...
<?php echo $__env->make('common::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\temancms\Modules\Post\Providers/../Resources/views/submitted_posts.blade.php ENDPATH**/ ?>