...
<?php $__env->startSection('content'); ?>
    <div class="dashboard-ecommerce">
        <div class="container-fluid dashboard-content ">
            <!-- page info start-->
            <?php echo Form::open(['route'=>['update-post','video',$post->id],'method' => 'post','enctype'=>'multipart/form-data']); ?>
                            ...
                            <div class="add-new-page  bg-white p-20 m-b-20">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input id="post-slug" name="slug" value="<?php echo e($post->slug); ?>" type="text"
                                               class="form-control">
                                    </div>
                                </div>
                                <!-- tinemcey start -->
                        ...
                        <div class="col-12 col-lg-3">
                            ...
                            <div class="add-new-page  bg-white p-20 m-b-20">
                                ...
                                <div class="add-video-tab">
                                    <nav>
                                        <div class="nav nav-tabs m-b-20" id="nav-tab" role="tablist">
                                            <a class="nav-item nav-link <?php if($post->video_id != null): ?> active <?php endif; ?>"
                                               id="upload-video-file" data-toggle="tab" href="#upload-video"
                                               role="tab"><?php echo e(__('upload_video')); ?></a>
                                            <a class="nav-item nav-link <?php if($post->video_id == null): ?> active <?php endif; ?>"
                                               id="video-link" data-toggle="tab" href="#video_by_link"
                                               role="tab"><?php echo e(__('remove_video')); ?></a>
                                        </div>
                                    </nav>

                                    <div class="tab-content" id="nav-tabContent">
                                        <div class="tab-pane fade <?php if($post->video_id != null): ?> show active <?php endif; ?>"
                                             id="upload-video" role="tabpanel">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="video_id" value="<?php echo e($post->video_id); ?>"
                                                               name="video_id" type="hidden" class="form-control video_id">
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        <div class="form-group text-center">
                                                            <?php if(isFileExist($post->video, @$post->video->video_thumbnail)): ?>
                                                                <img
                                                                    src="<?php echo e(basePath($post->video)); ?>/<?php echo e($post->video->video_thumbnail); ?> "
                                                                    id="video_thumb" width="200" height="200"
                                                                    alt="image" class="img-responsive img-thumbnail video_preview" style="display:inline">
                                                            <?php else: ?>
                                                                <img id="video_thumb"
                                                                     src="<?php echo e(static_asset('default-image/default-video-100x100.png')); ?> "
                                                                     id="image_preview" width="200" height="200"
                                                                     alt="image" class="img-responsive img-thumbnail video_preview">
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="tab-pane fade  <?php if($post->video_id == null): ?> show active <?php endif; ?>"
                                             id="video_by_link" role="tabpanel">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="video_url_type" name="video_url_type"
                                                            ...
                                                            <option <?php if($post->video_url_type=='mp4_url'): ?> selected
                                                                    <?php endif; ?> value="mp4_url">MP4 url
                                                            </option>
                                                            <option <?php if($post->video_url_type=='youtube_url'): ?> selected
                                                                    <?php endif; ?> value="youtube_url">Youtube url
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="video_url" value="<?php echo e($post->video_url); ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="video_thumbnail_id" value="<?php echo e($post->video_thumbnail_id); ?>"
                                           name="video_thumbnail_id" type="hidden" class="form-control image_id">
                                </div>
                                <div class="form-group">
                                    <div class="form-group text-center">
                                        <?php if($post->post_type=='video'): ?>
                                            <?php if(isFileExist(@$post->videoThumbnail, $result =  @$post->videoThumbnail->thumbnail)): ?>
                                                <img src=" <?php echo e(basePath($post->videoThumbnail)); ?>/<?php echo e($result); ?>"
                                                     id="video_thumb_preview"  width="200" height="200"alt="<?php echo $post->title; ?>" class="img-responsive img-thumbnail image_preview">
                                            <?php else: ?>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-group text-center">
                                            ...
                                            <?php else: ?>
                                                <img src="<?php echo e(static_asset('default-image/default-100x100.png')); ?> " id="image_preview" width="200" height="200" alt="image"
                                                     class="img-responsive img-thumbnail image_preview" alt="<?php echo $post->title; ?>">
                                            <?php endif; ?>
                                        </div>
                                    </div>
...
<?php echo $__env->make('common::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\temancms\Modules\Post\Providers/../Resources/views/video_post_edit.blade.php ENDPATH**/ ?>