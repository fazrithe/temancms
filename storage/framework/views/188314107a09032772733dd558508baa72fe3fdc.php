...
<?php $__env->startSection('settings_active'); ?>
    active
<?php $__env->stopSection(); ?>
<?php $__env->startSection('setting-ffmpeg'); ?>
    active
<?php $__env->stopSection(); ?>
                            ...
                            <div class="add-new-page  bg-white p-0 m-b-20">
                                ...
                                <nav>
                                    <div class="nav m-b-20 setting-tab" id="nav-tab" role="tablist">
                                        ...
                                        <a class="nav-item nav-link active" id="setting-ffmpeg"
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="recaptcha_settings" role="tabpanel">
                                        <?php echo Form::open(['route' => 'update-settings', 'method' => 'post', 'enctype' => 'multipart/form-data', 'id' => 'update-settings']); ?>
                                         ...
                                         <div class="col-sm-12">
                                            <div class="m-b-20">
                                                <span class=""><strong> <?php echo e(__('ffmpeg_description')); ?></strong> </span>
                                            </div>
                                        </div>
                                        <div class="row p-l-15">
                                            ...
                                            <div class="col-3 col-md-2">
                                                <label class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" name="ffmpeg_status" id="visibility_show"
                                                           value="1"
                                                           <?php echo e(settingHelper('ffmpeg_status') == 1? 'checked':""); ?> class="custom-control-input">
                                                    <span class="custom-control-label"><?php echo e(__('enable')); ?></span>
                                                </label>
                                            </div>
                                            <div class="col-3 col-md-2">
                                                <label class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" name="ffmpeg_status" id="visibility_hide"
                                                           value="0"
                                                           class="custom-control-input" <?php echo e(settingHelper('ffmpeg_status') == 0? 'checked':""); ?>>
