...
<?php $__env->startSection('api_active'); ?>
    active
<?php $__env->stopSection(); ?>
<?php $__env->startSection('android-settings'); ?>
    active
<?php $__env->stopSection(); ?>
                                    ...
                                    <div class="tab-pane fade show active" id="general_settings" role="tabpanel">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label for="latest_apk_version"
                                                       class="col-form-label"><?php echo e(__('latest_apk_version')); ?></label>
                                                <input id="latest_apk_version" class="form-control" name="latest_apk_version"
                                                       value="<?php echo e(settingHelper('latest_apk_version')); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label for="latest_apk_code"
                                                       class="col-latest_apk_code-label"><?php echo e(__('latest_apk_code')); ?></label>
                                                <input id="latest_apk_code" class="form-control" name="latest_apk_code"
                                                       value="<?php echo e(settingHelper('latest_apk_code')); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label for="apk_file_url"
                                                       class="col-form-label"><?php echo e(__('apk_file_url')); ?></label>
                                                <input id="apk_file_url" class="form-control" name="apk_file_url"
                                                       value="<?php echo e(settingHelper('apk_file_url')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                                <label for="whats_new_on_latest_apk"
                                                       class="col-form-label"><?php echo e(__('whats_new_on_latest_apk')); ?></label>
                                                <textarea name="whats_new_on_latest_apk" id="whats_new_on_latest_apk"
                                                          class="form-control"><?php echo e(settingHelper('whats_new_on_latest_apk')); ?></textarea>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-3 col-md-2">
                                                <label class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" name="apk_update_skipable_status" id="visibility_show"
                                                           value="true"
                                                           <?php echo e(settingHelper('apk_update_skipable_status') == true? 'checked':""); ?> class="custom-control-input">
                                            ...
                                            <div class="col-3 col-md-2">
                                                <label class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" name="apk_update_skipable_status" id="visibility_hide"
                                                           value="false"
                                                           class="custom-control-input" <?php echo e(settingHelper('apk_update_skipable_status') == 'false'? 'checked':""); ?>>
