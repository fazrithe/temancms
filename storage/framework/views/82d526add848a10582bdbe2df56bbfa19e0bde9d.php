...
<html lang="en">
  <head>
    ...
    <title><?php echo e(settingHelper('seo_title')); ?></title>
       ...
       <link rel="icon" type="image/x-icon" href="<?php echo e(static_asset(settingHelper('favicon'))); ?>">
    <!-- BOOTSTRAP -->
    <link rel="stylesheet" href="<?php echo e(static_asset('front-end/node_modules/bootstrap/dist/css/bootstrap.min.css')); ?>" />
    <!-- BOOTSTRAP -->
    <!-- Our CSS -->
    <link rel="stylesheet" href="<?php echo e(static_asset('front-end/src/css/global.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(static_asset('front-end/src/css/home.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(static_asset('front-end/src/css/navbar.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(static_asset('front-end/src/css/reportase.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(static_asset('front-end/src/css/footer.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(static_asset('front-end/src/css/ide-esai.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(static_asset('front-end/src/css/darkmode.css')); ?>" />
    <!-- Our CSS -->
  </head>
  <body>
    <?php echo $__env->make('site2.layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  ...
  <footer>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-6 ">
          <ul class="d-flex text-center">
            <li>
             <a href="<?php echo e(url('page/tentang-kami')); ?>"> Tentang Kami </a>
            </li>
            <li>
              <a href="<?php echo e(url('page/redaksi')); ?>"> Redaksi </a>
            </li>
            <li>
              <a href="<?php echo e(url('page/contact-us')); ?>"> Kontak Kami</a>
            </li>
            <li>
              <a href="<?php echo e(url('page/pedoman-media-siber')); ?>"> Pedoman Media Siber</a>
            </li>
          </ul>
        </div>
          </div>
   ...
   <!-- FOOTER -->
<!-- BOOTSTRAP -->
<script src="<?php echo e(static_asset('front-end/node_modules/bootstrap/dist/js/bootstrap.bundle.min.js')); ?>"></script>
<script src="<?php echo e(static_asset('front-end/src/js/index.js')); ?>"></script>
...
<?php /**PATH C:\laragon\www\temancms\resources\views/site2/layouts/app.blade.php ENDPATH**/ ?>