...
<?php $__env->startSection('post'); ?>
    active
<?php $__env->stopSection(); ?>
<?php $__env->startSection('slider-post-active'); ?>
    active
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="dashboard-ecommerce">
        <div class="container-fluid dashboard-content ">
            <!-- page info start-->
            <?php echo Form::open(['route'=>'update-slider-order','method' => 'post','enctype'=>'multipart/form-data']); ?>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="block-header">
                                            <h2><?php echo e(__('slider_posts')); ?></h2>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                        ...
                                        <tr id="row_<?php echo e($post->id); ?>">
                                            ...
                                            <td>
                                                <div class="post-image">
                                                    ...
                                                    <?php endif; ?>
                                                </div> <a href="<?php echo e(route('article.detail', [$post->slug])); ?>"><?php echo e($post->title); ?> </a> </td>
                                            ...
                                            <td width="10%">
                                                <input type="number" class="form-control btn btn-light" name="order[]"
                                                       value="<?php echo e($post->slider_order); ?>">
                                            ...
                                            <?php if(Sentinel::getUser()->hasAccess(['post_write'])): ?>
                                                <td>
                                                    <a href="javascript:void(0)"
                                                       onclick="remove_post_form('other','slider','<?php echo e($post->id); ?>')"
...
<?php echo $__env->make('common::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\temancms\Modules\Post\Providers/../Resources/views/slider_posts.blade.php ENDPATH**/ ?>