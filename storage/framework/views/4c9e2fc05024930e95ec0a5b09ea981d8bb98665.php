...
<?php $__env->startSection('content'); ?>
    ...
    <div class="dashboard-ecommerce">
        <div class="container-fluid dashboard-content ">
            <!-- page info start-->
            <?php echo Form::open(['route' => ['save-new-post','article'],'method' => 'post','enctype'=>'multipart/form-data']); ?>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-group text-center">
                                            ...
                                            <input type="text" class="form-control" name="title_image">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('common::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\temancms\Modules\Post\Providers/../Resources/views/article_create.blade.php ENDPATH**/ ?>