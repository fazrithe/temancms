...
<?php $__env->startSection('settings_active'); ?>
    active
<?php $__env->stopSection(); ?>
<?php $__env->startSection('cache-route-config'); ?>
    active
<?php $__env->stopSection(); ?>
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" role="tabpanel">
                                        <div class="block-header">
                                            ...
                                            <h2><?php echo e(__('cache_update')); ?></h2>
                                        </div>
                                        <?php echo Form::open(['route' => 'cache-update', 'method' => 'post' ]); ?>
                                        ...
                                        <div class="row p-l-15">
                                            <div class="col-12 col-md-4">
                                                <div class="form-title">
                                                    <label for="visibility"><?php echo e(__('cache')); ?></label>
                                                </div>
                                            </div>
                                            <div class="col-3 col-md-2">
                                                <label class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" name="config_cache" id="config_cache_enable"
                                                           value="enable"
                                                           <?php echo e(( File::exists(base_path().'/bootstrap/cache/config.php') || File::exists(base_path().'/bootstrap/cache/routes.php')) ? 'checked':""); ?> class="custom-control-input">
                                            ...
                                            <div class="col-3 col-md-2">
                                                <label class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" name="config_cache" id="config_cache_disable"
                                                           value="disable"
                                                           class="custom-control-input" <?php echo e((!File::exists(base_path().'/bootstrap/cache/config.php') && !File::exists(base_path().'/bootstrap/cache/routes.php')) ? 'checked':""); ?>>
