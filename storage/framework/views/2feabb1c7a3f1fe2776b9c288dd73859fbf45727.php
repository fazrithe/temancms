                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-5">
                            ...
                            <div class="add-new-page  bg-white p-20 m-b-20">
                                ...
                                <div class="col-sm-12">
                                    <div class="block-header">
                                        <h2><?php echo e(__('featured')); ?></h2>
                                    </div>
                                    <div class="row p-l-15">
                                        <div class="col-12 col-md-4">
                                            <div class="form-title">
                                                <label for="is_featured"><?php echo e(__('status')); ?></label>
                                            </div>
                                        </div>
                                ...
                                <div class="table-responsive all-pages">
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tr role="row">
                                            ...
                                            <th><?php echo e(__('is_featured')); ?></th>
                                        ...
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr role="row" class="odd" id="row_<?php echo e($category->id); ?>">
                                                ...
                                                <td><?php echo e($category->is_featured ? __('yes') : __('no')); ?></td>
                                                <?php if(Sentinel::getUser()->hasAccess(['category_write']) || Sentinel::getUser()->hasAccess(['category_delete'])): ?>
                                                    <td>
                                                        <div class="dropdown">
                                                            <button
...
<?php echo $__env->make('common::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\temancms\Modules\Post\Providers/../Resources/views/categories.blade.php ENDPATH**/ ?>