                                    ...
                                    $(".image_id").each(function () {
                                        if ($(this).val() != "") {
                                            ...
                                            if ($(this).val() == selected_image_id) {
                                                ...
                                                $(this).parents('.question-image').find('.image_preview').attr('src', '<?php echo e(static_asset('default-image/default-100x100.png')); ?>');
                                                $(this).parents('.result-image').find('.image_preview').attr('src', '<?php echo e(static_asset('default-image/default-100x100.png')); ?>');
...
<?php /**PATH C:\laragon\www\temancms\Modules\Gallery\Providers/../Resources/views/image-gallery.blade.php ENDPATH**/ ?>