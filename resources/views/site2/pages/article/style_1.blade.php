<div class="entry-header">
    ...
    <div class="d-flex justify-content-center">
        <div class="row">
            <div class="col text-center">
                <p class="date">{{ date('F j, Y', strtotime($post->updated_at)) }}</p>
                <p class="">{{ $post->user->first_name }} {{ $post->user->last_name }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="date-read col-12 mb-3 mt-3 d-flex align-items-center justify-content-between">
        <div class="text-end">
            <div class="d-flex justify-content-between">
                <p class="date text-center">{{ $post->title_image }}</p>
            </div>
