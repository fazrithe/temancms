...
class SeedSettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Setting::create(['title' => 'application_name', 'value' => 'TemanCMS', 'lang' => 'en']);
        ...
        Setting::create(['title' => 'mail_name', 'value' => 'Teman CMS', 'lang' => 'en']);
        ...
        //seo setting
        Setting::create(['title' => 'seo_title', 'value' => 'Teman CMS', 'lang' => 'en']);
        ...
        Setting::create(['title' => 'copyright_text', 'value' => 'Copyright © 2022 Teman CMS.', 'lang' => 'en']);
